package com.primeiro.pay.oppwa.payments.capture;

import com.primeiro.pay.oppwa.payments.capture.api.rest.CaptureVertx;
    ...
    public void start() {
        ...
        runVerticle(vertx -> ConfigRetriever.create(vertx, new ConfigRetrieverOptions() {
            ...
            if (ar.failed()) {
                ...
                vertx.deployVerticle(CaptureVertx::new, new DeploymentOptions().setConfig(ar.result()));
            }
        }), 10);
    }
}
